...
#            success_rate = (float(success_times) - success10_list[-9]) / 10
        ...
        if (update%1) == 0:
            ...
            with open('results/' + sys.argv[1] + '/sample.csv', 'w') as f:
                ...
                writer.writerow(avg_success_x_hist_list) #51
                writer.writerow(avg_success_y_hist_list) #52
                writer.writerow(avg_fail_x_hist_list) #53
                writer.writerow(avg_fail_y_hist_list) #54
